...
if (isset($_POST['psełdonim1']) && isset($_POST['tresc'])) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['psełdonim1'] = $_POST['psełdonim1'];
        $now = new DateTime();
        $nowFormatted = $now->format('Y-m-d H:i:s');
        echo "Wpis"."<br>".$_SESSION['temat']."<br>".$_SESSION['psełdonim']."<br>".$_SESSION['wpis']."<br>"."komentarz"."<br>".$_SESSION['temat']."<br>".$nowFormatted."<br>".$_SESSION['tresc']."<br>".$_SESSION['psełdonim1']."<br>";
    }
}
?>